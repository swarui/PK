    ...
    />
          ...
          >
            ...
            {/* <motion.p
              ...
              className="text-base md:text-lg lg:text-xl xl:text-[1.3em] text-black/80 max-w-xl text-center md:text-left"
            >
              I am committed to growth, innovation, and making a meaningful impact through dedication and continuous
              learning.
            </motion.p> */}
            ...
            <motion.div
              ...
              className="flex flex-col items-center md:items-start mt-4 md:mt-6"
            >
              <h3
                style={{ fontFamily: "Afacad" }}
                className="text-base md:text-lg lg:text-xl text-black mb-3 text-center md:text-left"
              >
                My socials 👇🏾
              </h3>
